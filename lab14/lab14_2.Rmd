...
aqua_carni_list<- list(swimming_vec,carni_vec, aqua_vec, ecto_vec)

ggVennDiagram(aqua_carni_list, category.names = c("Swimming", "Carni", "Aqua", "Ecto"))


# Make the plot:
ggVennDiagram(aqua_carni_list,
              set_color = c("black", "blue", "green", "red"),             # sets label colors
              category.names = c("aqua", "carni", "swimming", "ecto"),          # sets category label names
              label_color = "firebrick",                  # sets overlap-quantity label color
              label_size = 4                              # sets overlap-label size
              )+
  scale_color_brewer(palette = "Set3")+                   # sets palette for circle colors
