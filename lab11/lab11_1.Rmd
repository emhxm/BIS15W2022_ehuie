...
homerange%>%
  ggplot(aes(x=range_category, fill=class))+geom_bar(position="dodge",color="black", alpha=0.6)+labs(title="Observations by Range Category in Homerange Data", fill="Class")
