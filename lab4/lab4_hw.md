...
##  2 mammals red deer      mamma~ artiod~ cervi~ cerv~ elaphus telemetry*    <NA> 
##  3 mammals reindeer      mamma~ artiod~ cervi~ rang~ tarand~ telemetry*    <NA> 
##  4 mammals white-tailed~ mamma~ artiod~ cervi~ odoc~ virgin~ telemetry*    <NA> 
##  5 mammals fallow deer   mamma~ artiod~ cervi~ dama  dama    telemetry*    <NA> 
##  6 mammals chital        mamma~ artiod~ cervi~ axis  axis    telemetry*    <NA> 
##  7 mammals mule deer     mamma~ artiod~ cervi~ odoc~ hemion~ telemetry*    <NA> 
##  8 mammals pampas deer   mamma~ artiod~ cervi~ ozot~ bezoar~ telemetry*    <NA> 
##  9 mammals sika deer     mamma~ artiod~ cervi~ cerv~ nippon  telemetry*    <NA> 
## 10 mammals roe deer      mamma~ artiod~ cervi~ capr~ capreo~ telemetry*    <NA> 
## 11 mammals Reeves's mun~ mamma~ artiod~ cervi~ munt~ reevesi telemetry*    <NA> 
## 12 mammals pudu          mamma~ artiod~ cervi~ pudu  puda    telemetry*    <NA> 
...
```
## # A tibble: 41 x 4
##    species      family     common_name          mean_hra_m2
##    <chr>        <chr>      <chr>                      <dbl>
##  1 schneideri   viperidae  namaqua dwarf adder         200 
##  2 viridis      colubridae eastern worm snake          253 
##  3 butleri      colubridae butlers garter snake        600 
##  4 vermis       colubridae western worm snake          700 
##  5 latastei     viperidae  snubnosed viper            2400 
##  6 shedaoensis  viperidae  chinese pit viper          2614.
##  7 punctatus    colubridae ringneck snake             6476 
##  8 piscivorous  viperidae  cottonmouth               10655 
##  9 rufodorsatus colubridae redbacked ratsnake        15400 
## 10 catenifer    colubridae gopher snake              17400 
## # ... with 31 more rows
```
