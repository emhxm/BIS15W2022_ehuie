...
NA is a missing value. Therefore, a mean cannot be taken. 

4. Recalculate the mean using the following code chunk. Why is the useful?  THis code chunk is useful because na.rm removes the NA value so a mean can be calculated.
```{r}
